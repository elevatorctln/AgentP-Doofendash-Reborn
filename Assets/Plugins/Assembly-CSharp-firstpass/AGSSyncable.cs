...
public class AGSSyncable : IDisposable
{
	...
	{
		AndroidJavaObject androidJavaObject = ((key == null) ? javaObject.Call<AndroidJavaObject>(method, new object[0]) : javaObject.Call<AndroidJavaObject>(method, new object[1] { key }));
	...
	protected HashSet<string> GetHashSet(string method)
	{
		...
		AndroidJavaObject androidJavaObject = javaObject.Call<AndroidJavaObject>(method, new object[0]);
		if (androidJavaObject == null)
		{
			return hashSet;
		}
